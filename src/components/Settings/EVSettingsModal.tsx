...
import { X, Settings2, Battery, Zap } from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white border border-gray-100 rounded-3xl w-full max-w-md overflow-hidden shadow-[0_20px_60px_rgb(0,0,0,0.15)] flex flex-col">
                ...
                <div className="p-5 border-t border-gray-100 bg-gray-50/50">
                    <button
                        onClick={handleSave}
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-lg py-4 rounded-2xl transition-all shadow-lg shadow-blue-500/30 active:scale-[0.98]"
                    >
                        Save Profile
                    </button>
                </div>
