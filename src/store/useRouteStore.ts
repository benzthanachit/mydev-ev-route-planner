...
export const useRouteStore = create<RouteState>()(
    persist(
        ...
        {
            name: 'ev-route-storage',
            partialize: (state) => ({
                origin: state.origin,
                destination: state.destination,
                routeCoordinates: state.routeCoordinates,
                totalDistanceKm: state.totalDistanceKm,
                totalElevationGainMeters: state.totalElevationGainMeters,
                totalElevationLossMeters: state.totalElevationLossMeters,
                chargingWaypoints: state.chargingWaypoints,
                selectedWaypoints: state.selectedWaypoints,
                recommendedStationIds: state.recommendedStationIds
            }),
        }
    ));
